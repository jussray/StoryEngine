...
- Do not expose creator-submitted stories, community member data, moderation records, or unpublished content in search queries or outputs.
- Do not blend L99 community data with other Chief AI project content.
- Research outputs are informational only — not authorization to publish, deploy, or change moderation policy.

## Scope

Appropriate: story engine architecture research, creator economy best practices, community moderation frameworks, publicly available narrative tooling references. Not appropriate: exposing creator/community data, making production changes, or bypassing founder approval gates.
