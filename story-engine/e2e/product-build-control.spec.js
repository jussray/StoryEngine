...
test('dedicated FCR service principal executes one bounded actuator and gets a receipt', async ({ request }) => {
...
test('replaying the exact directive returns the original receipt', async ({ request }) => {
